        ...
        <div class="grid grid-cols-12">            
            ...
            <div class="col-span-6  col-start-4">
                <div class="border-t-2 border-r-2 border-l-2 border-dashed">
                    <br>
                    editar informacion de la encuesta: {{$encuesta->name}}
                </div>
                <div class="container">
                            ...
                            <form action="{{route('encuestas.update', $encuesta)}}" method="post">
                                ...
                                <div class="col-start-5 col-span-3">
                                    ...
                                    <label class="col-span-5">
                                        periodo:
                                        <input type="text" x-1 name="periodo" rows="5" value="{{old('name',$encuesta->name)}}"></textarea>
                                    </label>
                                <div class="col-start-5 col-span-3">
                                </div>
                                <div class="col-span-5"></div>
                                <div>
                                    ...
                                    <label >
                                        Area
                                        <input type="text" name="carrera" value="{{old('carrera',$encuesta->carrera)}}">
                                    </label>
                                </div>
                                <label>
                                    <br>
