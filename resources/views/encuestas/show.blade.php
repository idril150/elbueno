                ...
                <div class="ml-4">
                    <div class="grid grid-cols-12 p-6">
                        ...
                        <div class="text-end col-span-3 ">
                            <x-aa href="{{ route('encuestas.edit', $encuesta->id) }}">Editar información</x-aa>
                            <br><br><br>
                        ...
                        <div class="grid grid-cols-12 p-6">
                            <div class="col-span-8">
                                        ...
                                        <div class="grid grid-cols-12 p-4">
                                            ...
                                            <div class="container text-center">
                                                <div class="grid grid-flow-col gap-3">
                                                    ...
                                                    <div class="block">
                                                        <form action="{{ route('respuestas.cambiarEstado', $respuesta) }}" method="POST">
                                                            @csrf
                                                            @method('put')
                                            ...
                                            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                <form action="{{ route('respuestas.update', $respuesta) }}" method="POST">
                                                    ...
                                                    <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                        ...
                                                        <button type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-red-500 text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onclick="toggleModal('editModal{{ $respuesta->id }}')">Cancelar</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                @elseif ($pregunta->tipo == 2 )
                                    ...
                                    <select id="respuesta" name="respuesta" class="block w-full mt-1 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                    <option value="" disabled selected>seleccionar respuesta</option>
                                        @foreach ($pregunta->respuestas->where('estado', 1) as $respuesta)
                                            <option value="{{ $respuesta->texto }}">{{ $respuesta->texto }}</option>
                                        @endforeach 
                                    </select>
                                ...
                                <div class="py-12">
                                    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                                            ...
                                            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                                ...
                                                <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                    <form action="{{ route('preguntas.update', $pregunta->id) }}" method="POST">
                                                        ...
                                                        @method('PUT')
                                                        <div class="p-6">
                                                            <label for="texto" class="block font-medium text-gray-700 dark:text-gray-200">Editar pregunta:</label>
                                                            <input type="text" name="texto" id="texto" value="{{ $pregunta->texto }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:text-gray-200 dark:bg-gray-800 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                                        </div>
                                                        <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                            <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">Guardar cambios</button>
                                        ...
                                        <div class="col-span-4 col-start-2">
                                            ...
                                            @endif
                                            @if ($pregunta->tipo == 2) <!-- Verificar si la pregunta es de opción múltiple para mostrar opciones de agregar respuesta -->
                                                @for ($i = 0; $i < count($pregunta->respuestas->where('estado', 1)) - 1; $i++)
